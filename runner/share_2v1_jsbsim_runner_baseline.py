...
class Share2v1JSBSimRunner(Runner):
    ...
    def load(self):
        ...
        if self.use_selfplay:
            ...
            #     660: "results/SingleCombat/1v1/NoWeapon/HierarchySelfplay/ppo/v1/wandb/latest-run/files/actor_660.pt",
            ...
            # 随机选择初始策略
            initial_strategy = random.choice(self.model_checkpoints)
    ...
    #                         opponent_action = policy.act(opponent_obs_15d, deterministic=True)
