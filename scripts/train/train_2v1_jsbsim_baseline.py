...
from runner.share_2v1_jsbsim_runner_baseline_ppo import Share2v1JSBSimRunner
...
def parse_args(args, parser):
    ...
    group.add_argument('--scenario-name', type=str, default='2v1/NoWeapon/Selfplay',
                       help="Which scenario to run on")
    group.add_argument('--render-mode', type=str, default='txt',
                       help="txt or real_time")
    group.add_argument('--opponent-model-path', type=str, default=None,
                       help="Path to the pre-trained opponent model")
...
def main(args):
    ...
    # run experiments
    if all_args.env_name == "MultipleCombat":
        runner = Share2v1JSBSimRunner(config)
    else:
