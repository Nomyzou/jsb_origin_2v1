...
algo="mappo"
exp="v1_random_opponents"
seed=0

echo "env is ${env}, scenario is ${scenario}, algo is ${algo}, exp is ${exp}, seed is ${seed}"
echo "Using random opponent strategies: actor_250.pt, actor_440.pt, actor_1040.pt"

CUDA_VISIBLE_DEVICES=0 python train/train_2v1_jsbsim_baseline.py \
    ...
    --user-name "jyh" --use-wandb --wandb-name "thu_jsbsim_random_opponents" \
